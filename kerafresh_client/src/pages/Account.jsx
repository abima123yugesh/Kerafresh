...
import { userOrder } from "../features/order/orderSlice";
...
function Account() {
  ...
  useEffect(() => {
    dispatch(userOrder())
       ...
       const orderItemState = useSelector((state) => state.order?.placedOrders?.order)
  ...
  return (
    <div>
      ...
      <div
        className="ltn_breadcrumb-area ltnbreadcrumb-area-2 ltn_breadcrumb-color-white bg-overlay-theme-black-90 bg-image"
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div className="ltn_breadcrumb-inner ltn_breadcrumb-inner-2 justify-content-between">
                          ...
                          <div className="ltn__myaccount-tab-content-inner">
                            <div className="table-responsive">
                              <table className="table">
                                ...
                                {orderItemState?.map((order, index) => {
                                return (
                                <tbody key={index}>
                                  <tr>
                                    <td>{index + 1}</td>
